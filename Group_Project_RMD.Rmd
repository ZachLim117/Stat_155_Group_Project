...
>>>>>>> adfe186447ff523baedcd7d90d2bc9740cc0cfba
output:
  html_document:
    df_print: paged
---
...
*    Looks at how hate crimes varies by states and how might different variables be accountable for this crimes level. 
...
tidy(lm.income.fbi)
```
_This model explains the correlation between average hate crimes and median household income.The intercept coefficient is the mean median household income. The median_house_inc variable explains how much the predicted rates of hate crimes would increase based on increase in household income._ 
...
```
_Above, we calculated the confidence interval for the predicted effect on rates of hate crimes by the share of non white individuals in an area. An interesting thing to observe is that there is a decently wide range of possible effect of this coefficient on predicted rates of hate crimes, which is the subject of further investigation later._
